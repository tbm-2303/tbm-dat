...
class Game
{
  ...
  Game(int width, int height, int numberOfEnemies, int madAntal)
  {
    ...
    */
    ...
    {
      mad[n] = new Dot(round(random(1,width-2)),round(random(1,height-2)), width-2, height-2);}
    }
    ...
    for(int i = 0; i < mad.length; i++)
    {
     ...
     if(sum2 < sum3)  
      ...
      if(abs(dx_2) > abs(dy_2))  
          ...
          else if(dx_2 < 0 && mad[i].x < width-2)
          {
            //Player is to the left
            mad[i].moveRight();
          }
          }
          else if(dy_2 > 0 && mad[i].y > 1)
          {
          //Player is down;
          mad[i].moveUp();
          } 
          else if(dy_2 < 0 && mad[i].y < height - 2)
          { 
          //Player is up;
          mad[i].moveDown();
          }
        ...
        if (sum2 > sum3)
        {
          ...
          else if (dx_3 < 0 && mad[i].x < width-2)
          {
            //Player is to the left
            mad[i].moveRight();
          }
          }
          else if(dy_3 > 0 && mad[i].y > 1)
          {
          //Player is down;
          mad[i].moveUp();
          }
          else if(dy_3 < 0&& mad[i].y < height - 2)
          { 
          //Player is up;
          mad[i].moveDown();
          }
